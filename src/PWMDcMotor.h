...
#define DIRECTION_DIAGONAL_LEFT_FORWARD     (DIRECTION_LEFT + DIRECTION_FORWARD)    // 0x11
#define DIRECTION_DIAGONAL_LEFT_BACKWARD    (DIRECTION_LEFT + DIRECTION_BACKWARD)   // 0x12
#define DIRECTION_RIGHT                     0x20
#define DIRECTION_DIAGONAL_RIGHT_FORWARD    (DIRECTION_RIGHT + DIRECTION_FORWARD)   // 0x21
#define DIRECTION_DIAGONAL_RIGHT_BACKWARD   (DIRECTION_RIGHT + DIRECTION_BACKWARD)  // 0x22
...
#define DIRECTION_TURN_LEFT_IN_PLACE        (DIRECTION_TURN + DIRECTION_LEFT)                       // 0x50
#define DIRECTION_TURN_LEFT_FORWARD         (DIRECTION_TURN + DIRECTION_LEFT + DIRECTION_FORWARD)   // 0x51
#define DIRECTION_TURN_LEFT_BACKWARD        (DIRECTION_TURN + DIRECTION_LEFT + DIRECTION_BACKWARD)  // 0x52
#define DIRECTION_TURN_RIGHT_IN_PLACE       (DIRECTION_TURN + DIRECTION_RIGHT)                      // 0x60
#define DIRECTION_TURN_RIGHT_FORWARD        (DIRECTION_TURN + DIRECTION_RIGHT + DIRECTION_FORWARD)  // 0x61
#define DIRECTION_TURN_RIGHT_BACKWARD       (DIRECTION_TURN + DIRECTION_RIGHT + DIRECTION_BACKWARD) // 0x62
