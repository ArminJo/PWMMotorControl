 ...
 */
{ COMMAND_FORWARD, IR_COMMAND_FLAG_BLOCKING, &goForward, forward }, /**/
{ COMMAND_BACKWARD, IR_COMMAND_FLAG_BLOCKING, &goBackward, backward }, /**/
{ COMMAND_RIGHT, IR_COMMAND_FLAG_BLOCKING, &turnRight, right }, /**/
{ COMMAND_LEFT, IR_COMMAND_FLAG_BLOCKING, &turnLeft, left }, /**/
